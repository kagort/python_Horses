...
if e==h[0] and h[0]>h[1]:
    money = (money-d) + d*10
    print(f"Ты получил {d*10} долларов. Теперь у тебя в кармане {money} долларов.")
elif e==h[0] and h[0]==h[1]:
    money = (money-d) + d * 7
    print(f"Ты получил {d * 7} долларов. Теперь у тебя в кармане {money} долларов.")
elif e==h[1] and h[1]!= h[0]:
    money = (money-d) + d * 5
    print(f"Ты получил {d * 5} долларов. Теперь у тебя в кармане {money} долларов.")
elif e==h[2]:
    money = (money-d) * 3
    print(f"Ты получил {d * 3} долларов. Теперь у тебя в кармане {money} долларов.")
else:
    money = money - d
    print(f"Увы, ты проиграл! Теперь у тебя в кармане {money} долларов.")
